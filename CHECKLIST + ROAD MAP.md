...
| Элемент | Статичное состояние | Поведение при взаимодействии | Статус | Дата |
| --- | --- | --- | --- | --- |
| Версия приложения | Файл `VERSION` содержит `3.1.22`, номер повышается вместе с визуальными правками. | Контроль версии синхронизирован с дорожной картой. | решено | 2025-10-12 |
