...
- **Единый стиль кнопок.** StyledToolButton/StyledPushButton визуально отличаются друг от друга: заметны острые углы у элементов
  ...
  хранит раздельные профили idle/hover и возвращает приглушённый неон сразу после ухода курсора. 2025-10-22: повторное применение `CollapsibleSidebar.apply_style()` использует mixin-профили, idle-кнопки оставляют неоновый контур.
...
| Кнопка «Вводные» | Exo 2 16 px, текст `#ffffff` и иконка `#39ff14` центрируются внутри градиента `#39ff14→#2d7cdb`, радиус 16 px; углы рендерятся ступенчато. 2025-10-02: ручные пробелы убраны, контент центрирован. | Hover: заливка сереет, текст обесцвечивается до `#bfbfbf`, неон отключается, внешнее свечение отсутствует; активное состояние сбрасывается после закрытия окна. 2025-10-22: `apply_style()` повторно включает idle/hover профили миксина и сохраняет неон для активной и соседних кнопок. | частично решено | 2025-10-22 |
| Кнопка «Выкладка» | Аналогично «Вводные»: Exo 2 16 px, текст `#ffffff`, иконка 22×22 `#39ff14`, центрируется внутри кнопки. | Hover/клик: градиент тускнеет до серого, текст неонового свечения не получает, внешнего ореола нет, неон гаснет частично. 2025-10-22: idle-состояние сохраняет неоновый контур после повторного применения темы. | частично решено | 2025-10-22 |
| Кнопка «Аналитика» | StyledToolButton с Exo 2 16 px, текст `#ffffff`, иконка `#39ff14` центрированы; визуально видны острые углы. | Hover: фон сереет, текст становится `#bfbfbf`, неон и подсветка исчезают; после закрытия диалога подсветка не восстанавливается. 2025-10-22: повторный вызов `apply_style()` оставляет активный и соседние элементы с неоновым контуром. | частично решено | 2025-10-22 |
| Кнопка «Топы» | Текст `#ffffff` и иконка `#39ff14` выровнены по центру без пустого поля справа; углы неровные. | Hover: фон серый, текст тускнеет до `#bfbfbf`, неон гаснет, свечение по контуру отсутствует; при открытии окна подсветка сбрасывается. 2025-10-22: повторное применение настроек оставляет idle неон активным. | частично решено | 2025-10-22 |
