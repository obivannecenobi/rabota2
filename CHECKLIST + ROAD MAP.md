...
| Элемент | Статичное состояние | Поведение при взаимодействии | Статус | Дата |
| --- | --- | --- | --- | --- |
| Версия приложения | Файл `VERSION` содержит `3.1.3`, обновление номера выполняется вручную. | Требуется повышать версию при каждом фиксировании изменений. | требует доработки | 2025-09-18 |
