...
- поддержка шрифтов Exo 2 и Inter;
- регулируемая скорость анимаций;
- пульсирующий неон.
...
Для выпуска новой версии используйте скрипт `release.sh`. Он автоматически увеличит номер версии, создаст коммит и тег:
